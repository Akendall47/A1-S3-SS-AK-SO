...
| ---------------------------- | ----------------------------------------------------------- | -------------------------------------- | -------------------------- | --------------- | --------- |
| 1. Basic Commands            | Implement fork/execvp, basic command parsing                |                                    | `main` (done)              | ✅ Done          |           |
...
| 8. Further Enhancements      | Optional: globbing, job control, command history            |                                    | `feature/enhancements`     | 💤 Optional     |           |
